        ...
        <div className="flex flex-col min-h-screen bg-gray-100">
            <main className="flex-grow w-full flex flex-col lg:flex-row items-center justify-around py-12 px-4 lg:px-16 bg-gray-100">
                <div className="lg:w-1/2 text-center lg:text-left">
                    ...
                    <p className="text-lg mb-6">
                        T-Square provides a comprehensive task management system that helps you prioritize, track, and manage your tasks efficiently. 
            ...
            <section className="w-full py-16 px-4 lg:px-16 bg-gray-100">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl font-bold text-gray-900 mb-12">Why Choose T-Square?</h2>
            ...
            <section className="w-full p-4 text-center border border-gray-200 rounded-lg shadow sm:p-8 dark:border-gray-700 bg-gray-100">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <Carousel className="w-full max-w-4xl mx-auto">
                        <CarouselContent>
                            {[
                                { name: "Jane Doe", rating: 4, review: "T-Square has transformed the way I manage my tasks. The interface and the features are exactly what I needed." },
                                { name: "John Smith", rating: 5, review: "As a project manager, T-Square has been invaluable in keeping my team organized and on track. Highly recommend!" },
                                { name: "Emily Johnson", rating: 4, review: "I've tried many task management tools, but T-Square stands out for its ease of use and powerful features." }
                            ].map((review, index) => (
            ...
            {/* Work Fast From Anywhere Section */}
            <section className="w-full p-4 text-center border border-gray-200 rounded-lg shadow sm:p-8 dark:border-gray-700 bg-gray-100">
                <h5 className="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Manage your tasks from anywhere</h5>
                <p className="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Stay up to date and move forward with T-Square on iOS & Android. Download the app today.</p>
